	...
	Themes = {
		Blue = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 20, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 25, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 20, 30))
			}),
			["Color Hub 2"] = Color3.fromRGB(18, 22, 35),
			["Color Stroke"] = Color3.fromRGB(30, 40, 60),
			["Color Theme"] = Color3.fromRGB(40, 90, 180), -- Azul escuro
			["Color Text"] = Color3.fromRGB(235, 235, 235),
			["Color Dark Text"] = Color3.fromRGB(170, 180, 200)
		}
	},
