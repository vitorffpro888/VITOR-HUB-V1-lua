	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIsland") then
			for r, v in pairs(game.workspace.Map.MysticIsland:GetChildren()) do
				if v:IsA("MeshPart") and v.MeshId == "2277270153114969" then
					return v
				end
			end
		end
...
local OrionLib = ')))()
local Window = OrionLib:MakeWindow({Name = "vitor hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "vitor hub"})

OrionLib:MakeNotification({
	Name = "vitor hub",
	Content = "Choose Teams Bro?",
	Image = "22772719980140458596",
	Time = 7
})
